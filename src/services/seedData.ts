...
export const INITIAL_GYM_SETTINGS: GymSettings = {
  id: 'gym-infinity-main',
  name: 'INFINITY FITNESS CLUB',
  slug: 'infinity-main',
  tagline: 'NO LIMITS. JUST PROGRESS.',
  supportingConcept: 'Personalized Fitness Without the Crowd.',
  phone: '+91 98765 43210',
  whatsapp: '+91 98765 43210',
  email: 'contact@infinityfitnessclub.in',
  address: 'Plot 42, Zenith Boulevard, Sector 18, Central City',
  openingHours: 'Mon - Sat: 5:30 AM – 10:30 PM | Sun: 7:00 AM – 2:00 PM',
  announcement: '🔥 New Olympic Deadlift Platforms & AI Crowd Flow System Now Live!',
  currency: '₹',
  ...
  facilities: [
    ...
    'Physiotherapy & Mobility Screening Bay',
...
export const INITIAL_MEMBERS: UserProfile[] = [
  {
    ...
    role: 'member',
    memberId: 'IFC-1001',
    qrToken: 'IFC_TOKEN_SEC_ARUN_772A',
    status: 'ACTIVE',
  ...
  },
  {
    ...
    role: 'member',
    memberId: 'IFC-1002',
    qrToken: 'IFC_TOKEN_SEC_NEHA_883B',
    status: 'ACTIVE',
  ...
  },
  {
    ...
    role: 'member',
    memberId: 'IFC-1003',
    qrToken: 'IFC_TOKEN_SEC_ROHIT_994C',
    status: 'ACTIVE',
  ...
  },
  {
    ...
    role: 'member',
    memberId: 'IFC-1004',
    qrToken: 'IFC_TOKEN_SEC_ANJALI_115D',
  ...
  },
  {
    ...
    role: 'member',
    memberId: 'IFC-1005',
    qrToken: 'IFC_TOKEN_SEC_KABIR_226E',
    status: 'ACTIVE',
    membershipPlanId: 'plan-annual',
    planName: 'Annual Infinity VIP',
  ...
  },
  {
    ...
    role: 'member',
    memberId: 'IFC-1006',
    qrToken: 'IFC_TOKEN_SEC_RIYA_337F',
    status: 'ACTIVE',
    membershipPlanId: 'plan-quarterly',
    planName: 'Quarterly Transformation',
  ...
  },
  {
    ...
    role: 'member',
    memberId: 'IFC-1007',
    qrToken: 'IFC_TOKEN_SEC_ADITYA_448G',
    status: 'TRIAL',
    membershipPlanId: 'plan-monthly',
  ...
  },
  {
    ...
    role: 'member',
    memberId: 'IFC-1008',
    qrToken: 'IFC_TOKEN_SEC_SID_559H',
    status: 'EXPIRED',
    membershipPlanId: 'plan-monthly',
    planName: 'Monthly Pro',
    membershipStart: '2026-08-01',
  ...
  },
  {
    ...
    role: 'member',
    memberId: 'IFC-1009',
    qrToken: 'IFC_TOKEN_SEC_TANVI_660I',
    status: 'FROZEN',
    membershipPlanId: 'plan-annual',
    planName: 'Annual Infinity VIP',
  ...
  },
  {
    ...
    role: 'member',
    memberId: 'IFC-1010',
    qrToken: 'IFC_TOKEN_SEC_DEV_771J',
    status: 'ACTIVE',
    membershipPlanId: 'plan-half-yearly',
    planName: 'Half-Yearly Elite',
